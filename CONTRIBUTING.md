# Contributing to nist-csf-v2

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
nist-csf-v2. These guidelines are not strict rules.
...
The nist-csf-v2 team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the nist-csf-v2 technical leads
...
[issues]: https://github.com/lmodel/nist-csf-v2/issues/
[pulls]: https://github.com/lmodel/nist-csf-v2/pulls/
