...
class CSFElement(ConfiguredBaseModel):
    ...
    id: Optional[str] = Field(default=None, description="""Unique identifier for a catalog element""", json_schema_extra = { "linkml_meta": {'domain_of': ['CSFElement', 'CSFPart', 'Role'],
         'exact_mappings': ['cis_controls:id'],
         'in_subset': ['nist_csf_v2_catalog']} })
    ...
    title: Optional[str] = Field(default=None, description="""Human-readable title""", json_schema_extra = { "linkml_meta": {'domain_of': ['CSFMetadata', 'CSFElement', 'Role', 'Resource'],
         'exact_mappings': ['cis_controls:title'],
         'in_subset': ['nist_csf_v2_catalog']} })
...
class CSFFunction(CSFElement):
    ...
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'close_mappings': ['cis_controls:SecurityFunction'],
         'from_schema': 'https://w3id.org/lmodel/nist-csf-v2',
         'in_subset': ['nist_csf_v2_catalog']})

    controls: Optional[list[CSFCategory]] = Field(default=None, description="""List of categories or subcategories within a function or category""", json_schema_extra = { "linkml_meta": {'close_mappings': ['cis_controls:safeguards'],
         'domain_of': ['CSFFunction', 'CSFCategory'],
         'in_subset': ['nist_csf_v2_catalog']} })
    id: Optional[str] = Field(default=None, description="""Unique identifier for a catalog element""", json_schema_extra = { "linkml_meta": {'domain_of': ['CSFElement', 'CSFPart', 'Role'],
         'exact_mappings': ['cis_controls:id'],
         'in_subset': ['nist_csf_v2_catalog']} })
...
class CSFCategory(CSFElement):
    ...
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'close_mappings': ['cis_controls:CISControl'],
         'from_schema': 'https://w3id.org/lmodel/nist-csf-v2',
         'in_subset': ['nist_csf_v2_catalog'],
         'slot_usage': {'controls': {'name': 'controls', 'range': 'CSFSubcategory'}}})

    controls: Optional[list[CSFSubcategory]] = Field(default=None, description="""List of categories or subcategories within a function or category""", json_schema_extra = { "linkml_meta": {'close_mappings': ['cis_controls:safeguards'],
         'domain_of': ['CSFFunction', 'CSFCategory'],
         'in_subset': ['nist_csf_v2_catalog']} })
    id: Optional[str] = Field(default=None, description="""Unique identifier for a catalog element""", json_schema_extra = { "linkml_meta": {'domain_of': ['CSFElement', 'CSFPart', 'Role'],
         'exact_mappings': ['cis_controls:id'],
...
class CSFSubcategory(CSFElement):
    ...
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'close_mappings': ['cis_controls:Safeguard'],
         'from_schema': 'https://w3id.org/lmodel/nist-csf-v2',
         'in_subset': ['nist_csf_v2_catalog']})
